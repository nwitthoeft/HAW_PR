...
void main(int argc, char* argv[])
{
	...
	do {
		...
		case 'm':
			...
			printf("Anzahl der Argumente: %d\n", argc); //Es wird 1 eins ausgegegeb, weil das Betriebssystem immer als erstes Argument den Namen des ausgeführten Programmes mit der gesamten Pfadangabe mit der das Programm aufgerufen wurde übergibt.
